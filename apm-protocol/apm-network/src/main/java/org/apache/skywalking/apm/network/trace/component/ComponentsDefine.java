...
public class ComponentsDefine {
    ...
    public static final OfficialComponent MISSiAN = new OfficialComponent(93, "missian");

    public static final OfficialComponent HUTOOL_HTTP = new OfficialComponent(94, "hutool-http");
}
